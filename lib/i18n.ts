...
export interface Translations {
  ...
  profile: {
    ...
    daysInARow: string
    toLevel: string
    blocksUnlockedByProgress: string
    required: string
    personalInfo: string
...
export const translations: Record<Locale, Translations> = {
  en: {
    ...
    auth: {
      ...
      loginDescription: "Sign in to your account to access premium health information",
      enterPassword: "Enter your password",
      loggingIn: "Signing in...",
      noAccount: "Don't have an account?",
      registerLink: "Create one here",
      registerDescription: "Create an account to access premium health information",
      ...
      nicknameHelp: "This will be displayed on your profile",
      dataStorageInfo: "Your data is stored securely and will not be shared with third parties",
    },
    profile: {
      ...
      daysInARow: "Days in a row studying",
      toLevel: "to level",
      blocksUnlockedByProgress: "Blocks you've unlocked with your progress",
      required: "Required",
  ...
  ru: {
    ...
    hero: {
      title: "Ваш центр медицинской информации",
      subtitle:
        "Получите доступ к премиальной медицинской информации и экспертным рекомендациям для улучшения вашего здоровья",
      cta: "Начать",
    },
    auth: {
      login: "Войти",
      ...
      loginDescription: "Войдите в свой аккаунт для доступа к премиальной медицинской информации",
      enterPassword: "Введите ваш пароль",
      loggingIn: "Вход в систему...",
      noAccount: "Нет аккаунта?",
      registerLink: "Создайте здесь",
      registerDescription: "Создайте аккаунт для доступа к премиальной медицинской информации",
      ...
      nicknameHelp: "Это будет отображаться в вашем профиле",
      dataStorageInfo: "Ваши данные хранятся безопасно и не будут переданы третьим лицам",
    },
    profile: {
      memberSince: "С",
      ...
      daysInARow: "Дней подряд изучаете",
      toLevel: "до уровня",
      blocksUnlockedByProgress: "Блоки, которые вы разблокировали своим прогрессом",
      required: "Требуется",
      ...
      noData: "Нет данных",
      studiedBlocks: "Изученных блоков",
  ...
  sk: {
    ...
    hero: {
      ...
      subtitle: "Získajte prístup k prémiových zdravotným informáciám a odborným radám na zlepšenie vášho zdravia",
      cta: "Začať",
    },
    auth: {
      login: "Prihlásiť sa",
      ...
      loginError: "Chyba prihlásenia. Skontrolujte vaše údaje.",
      ...
      loginDescription: "Prihláste sa do svojho účtu pre prístup k prémiových zdravotným informáciám",
      enterPassword: "Zadajte vaše heslo",
      loggingIn: "Prihlasovanie...",
      noAccount: "Nemáte účet?",
      registerLink: "Vytvorte si ho tu",
      registerDescription: "Vytvorte si účet pre prístup k prémiových zdravotným informáciám",
      enterFirstName: "Zadajte vaše meno",
      enterLastName: "Zadajte vaše priezvisko",
      enterEmail: "Zadajte vašu emailovú adresu",
      ...
      userExists: "Používateľ s týmто emailom už existuje",
      passwordTooShort: "Heslo musí mať minimálne 6 znakov",
      nicknameHelp: "Toto sa zobrazí vo vašom profile",
      dataStorageInfo: "Vaše údaje sú bezpečne uložené a nebudú zdieľané s tretími stranami",
    },
    profile: {
      memberSince: "Člen od",
      maxLevelReached: "Maximálna úroveň dosiahnutá",
      hours: "h",
      minutes: "m",
      outOf: "z",
      available: "dostupných",
      streakDays: "Séria dní",
      daysInARow: "Dní po sebe študujete",
      toLevel: "do úrovne",
      blocksUnlockedByProgress: "Bloky, ktoré ste odomkli svojím pokrokom",
      required: "Požadované",
      ...
      noData: "Žiadne údaje",
      studiedBlocks: "Študovaných blokov",
      resetStats: "Resetovať štatistiky",
    },
    experience: {
      level: "Úroveň",
